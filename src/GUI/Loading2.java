...
public class Loading2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblValueNumber.setForeground(new java.awt.Color(255, 255, 255));
        lblValueNumber.setText("0%");

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlynhanvienquancafe/images/cofe2.jpg"))); // NOI18N
    ...
    public void startLoading() {
        Thread loadingThread = new Thread(() -> {
            ...
            if (isCompleted) {
                EmployeeSalaryManagement cr = new EmployeeSalaryManagement();
                cr.setVisible(true);
                setVisible(false);
            }
        });
